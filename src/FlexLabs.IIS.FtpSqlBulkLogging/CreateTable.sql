...
CREATE CLUSTERED COLUMNSTORE INDEX [PK_IIS_FtpLogs] ON [flexlabs].[IIS_FtpLogs] WITH (DROP_EXISTING = OFF, COMPRESSION_DELAY = 0, DATA_COMPRESSION = COLUMNSTORE) ON [IISLogsDate]([Date])
